...
const regions = [
  { name: "General Hospitals", nodes: 12, status: "operational" },
  { name: "Specialist Clinics", nodes: 8, status: "operational" },
  { name: "Emergency Rooms", nodes: 6, status: "operational" },
  { name: "Diagnostic Centers", nodes: 3, status: "operational" },
];
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Fidele connects to real hospital databases and specialist networks.
                Get instant clinical recommendations and navigation directions near you.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                ...
                <span className="text-2xl text-muted-foreground">clinics</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Clinics and diagnostics systems connected across regional healthcare databases.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-100 ${
              ...
              <span className="text-5xl lg:text-6xl font-display">95.4%</span>
              <span className="block text-sm text-muted-foreground mt-2">Triage Accuracy</span>
            </div>
            
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}>
              <span className="text-5xl lg:text-6xl font-display">&lt;2s</span>
              <span className="block text-sm text-muted-foreground mt-2">Triage Latency</span>
            </div>
          </div>
        </div>
