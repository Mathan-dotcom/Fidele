...
const testimonials = [
  {
    quote: "Fidele has drastically optimized our clinical intake. Patients are triaged instantly before seeing a physician.",
    author: "Dr. Sarah Chen",
    role: "Chief Medical Officer",
    company: "Meridian Health",
    metric: { value: "85%", label: "Faster triage" },
  },
  {
    quote: "The Geo-Radar integration is a lifesaver. Patients in emergencies are automatically routed to the closest clinic.",
    author: "Marcus Webb",
    role: "Director of Emergency Care",
    company: "Flux Medical",
    metric: { value: "<2s", label: "Clinic routing" },
  },
  {
    quote: "HIPAA compliance was a must for us. Fidele provides secure encrypted sessions with full patient profile separation.",
    author: "Elena Rodriguez",
    role: "VP of Healthcare Tech",
    company: "Beacon Health",
    metric: { value: "100%", label: "HIPAA compliant" },
  },
  {
    quote: "Security was our biggest concern. The patient-data sandbox and encrypted health vault gave us full confidence.",
    author: "James Liu",
    role: "CISO",
    company: "Prism Analytics",
    metric: { value: "0", label: "Data breaches" },
  },
];
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-40 bg-foreground text-background overflow-hidden">
      ...
      <div className="absolute inset-0 font-mono text-[10px] text-background/[0.02] leading-tight overflow-hidden whitespace-pre select-none">
        {isMounted && Array.from({ length: 60 }, (_, i) => 
