...
const securityFeatures = [
  {
    icon: Shield,
    title: "HIPAA Sandbox",
    description: "Each symptom assessment runs in its own isolated secure session.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Encrypted Health Vault",
    description: "Personal health records and vitals are encrypted at rest and in transit.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Clinical Audit Logs",
    description: "Every diagnostic request is logged securely for certified clinical review.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Patient Data Control",
    description: "You decide who has access to your medical information.",
