...
const REGIONS = [
  { name: "SYMPTOM_ENGINE", status: "OPERATIONAL", latency: "12ms" },
  { name: "HOSPITAL_GEOMAP", status: "OPERATIONAL", latency: "45ms" },
  { name: "DOCTOR_PARTNERS", status: "OPERATIONAL", latency: "180ms" },
  { name: "GEO_DB_ROUTING", status: "OPERATIONAL", latency: "8ms" },
]
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <span
                ...
                style={{
                  backgroundColor: region.status === "OPERATIONAL" ? "#3b82f6" : "hsl(var(--muted-foreground))",
                }}
              />
