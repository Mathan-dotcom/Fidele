  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between border-b-2 border-foreground px-4 py-2">
        ...
        <span className="bg-[#3b82f6] h-2 w-2" />
      </div>
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="1.2s" label="Avg AI Response" delay={500} />
        <ScrambleNumber target="98.4%" label="Accuracy Index" delay={800} />
        <ScrambleNumber target="250+" label="Clinical Partners" delay={1100} />
        <ScrambleNumber target="48.2K" label="Assessments / day" delay={1400} />
      </div>
    </div>
  )
}
