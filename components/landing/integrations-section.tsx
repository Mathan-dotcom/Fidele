...
const integrations = [
  { name: "OpenAI", category: "clinical LLM" },
  { name: "Anthropic", category: "triage routing" },
  { name: "Slack", category: "messaging" },
  { name: "GitHub", category: "code base" },
  { name: "Jira", category: "patient tickets" },
  { name: "AWS S3", category: "HIPAA storage" },
  { name: "Google Drive", category: "EHR docs" },
  { name: "Salesforce", category: "patient CRM" },
  { name: "HubSpot", category: "patient portal" },
  { name: "Zapier", category: "lab workflows" },
  { name: "Snowflake", category: "clinical data" },
    ...
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
          ...
          Connect
          <br />
          <span className="text-muted-foreground">your care.</span>
        </h2>

        <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          Fidele connects with your digital health logs, patient portals, and emergency networks to keep your care history synchronized.
        </p>
      </div>
