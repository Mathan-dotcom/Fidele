...
const footerLinks = {
  Product: [
    { name: "Triage capabilities", href: "#features" },
    { name: "How it works", href: "#how-it-works" },
    { name: "Geo Radar", href: "#infra" },
  ],
  Clinicians: [
    { name: "Medical Guidelines", href: "#developers" },
    { name: "Telehealth SDK", href: "#" },
    { name: "API Reference", href: "#developers" },
    { name: "Emergency Status", href: "#" },
  ],
  Company: [
    { name: "About Us", href: "#" },
  ...
  Legal: [
    { name: "HIPAA Privacy Policy", href: "#" },
    { name: "Terms of Use", href: "#" },
    { name: "Clinical Security", href: "#security" },
  ],
};
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="py-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/30">
            &copy; 2026 FIDELE. All rights reserved.
          </p>

          <div className="flex items-center gap-4 text-sm text-white/30">
            <span className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#eca8d6]" />
              All triage services operational
            </span>
          </div>
        </div>
      </div>
