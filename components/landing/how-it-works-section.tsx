...
const steps = [
  {
    ...
    title: "Describe",
    subtitle: "symptoms",
    description: "Describe your symptoms to Fidele in natural language. Enter severity, duration, and associated vitals details.",
    code: `const symptomCheck = new Session({
  query: "High fever with severe headache",
  duration: "3 days",
  vitals: { temp: "102F" },
  secureMode: true
})`,
  },
  {
    ...
    description: "Fidele parses the query to analyze and route: it triages risk levels (Low, Medium, High) and recommends specialties.",
    code: `const result = await Fidele.analyze(symptomCheck)
// Triage Result:
// {
//   riskLevel: "HIGH",
...
// }`,
  },
  {
    number: "03",
    title: "Locate",
    subtitle: "nearest care",
    description: "Search coordinates on the geo-radar dashboard. Navigate immediately to the closest validated care facilities.",
    code: `const nearestCare = await Radar.search({
  radiusKm: 5,
  specialty: result.specialty
})
// Found: 3 hospitals near you
// Geo radar visualization active`,
  },
];
